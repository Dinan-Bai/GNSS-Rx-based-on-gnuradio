        ...
        if self.mode == 0: # Cold start mode
            ...
            if self.search_state == 0: 
                ...
                if snr_avg > 6 and snr_std > 6.5:
                    ...
                    self.found_PRN.append(self.PRN_ref[0]) # put the PRN into the found list
            ...
            if self.track_loopN == 0: # first tracking loop
                if self.track_PRN != 0:
                    ...
                    # print(print('tracking delay = ',self.track_delay,'doppler = ', doppler))
                    self.track_loopN += 1
                ...
                if self.track_loopN <= 100:
                    print('tracking loop',self.track_loopN,',tracking delay = ',delay,',doppler = ', doppler,',phase=',phase/np.pi*180,',SNR=',snr_avg)
                self.track_loopN += 1
